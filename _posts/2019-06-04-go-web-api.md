...
category: blog
author: rshipp
description: Build a functioning HTTP API with basic [CRUD][5] features and an SQL backend, in this first post in a series on learning through hands-on projects.
---
